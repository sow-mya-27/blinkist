    ...
    <div className={classes.root}>
      ...
      <div className={classes.flex}>
        <div className={classes.flexCol}>
          ...
          <Button
            variant="text"
            startIcon={<BusinessCenterOutlinedIcon sx={{ color: "#6D787E" }} />}
          >
        ...
        <div className={classes.flexCol}>
          ...
          <Button
            variant="text"
            startIcon={<FontAwesomeIcon icon={faCommentAlt} color="#6D787E" />}
          >
          ...
          <Button
            variant="text"
            startIcon={<FavoriteBorderOutlinedIcon sx={{ color: "#6D787E" }} />}
          >
